...
%prep
%setup -q -n pre_commit-2.15.0
cd %{_builddir}/pre_commit-2.15.0
...
cp %{_builddir}/pre_commit-2.15.0/LICENSE %{buildroot}/usr/share/package-licenses/pre_commit/0a1b7c6ad0735b8a94231652bab67240e4b834f6
