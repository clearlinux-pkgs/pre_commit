...
Source0  : https://files.pythonhosted.org/packages/44/16/2cbffd43ba19e972cbea241618926532c2047d4c71b677ddba9674f6fde6/pre_commit-2.14.0.tar.gz
...
%prep
%setup -q -n pre_commit-2.14.0
cd %{_builddir}/pre_commit-2.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628532846
...
cp %{_builddir}/pre_commit-2.14.0/LICENSE %{buildroot}/usr/share/package-licenses/pre_commit/0a1b7c6ad0735b8a94231652bab67240e4b834f6
