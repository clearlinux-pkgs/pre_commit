...
Source0  : https://files.pythonhosted.org/packages/f9/3e/14f27cbad8703a2bb3229bf94926582509c190d750afb3ac3d318551829b/pre_commit-2.14.1.tar.gz
...
BuildRequires : cfgv
BuildRequires : identify
BuildRequires : nodeenv
BuildRequires : toml
...
%prep
%setup -q -n pre_commit-2.14.1
cd %{_builddir}/pre_commit-2.14.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630340964
...
cp %{_builddir}/pre_commit-2.14.1/LICENSE %{buildroot}/usr/share/package-licenses/pre_commit/0a1b7c6ad0735b8a94231652bab67240e4b834f6
